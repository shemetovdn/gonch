<?php
    ...
    $objects = \backend\modules\objectTypes\models\ObjectTypes::find()->where(['like','category_ids',''.$category_id.''])->asArray()->all();
                ...
                <ul>
                    ...
                    <li class="li-price">
                        <div class="price-filter">
                            <input name="price-from" type="number" placeholder="от"  value="<?php echo !empty($price_from)?$price_from:"";?>">
                            <span class="price-separ">—</span>
                            <input name="price-to" type="number" placeholder="до" value="<?php echo !empty($price_to)?$price_to:"";?>">
                            <span>Р</span>
                        </div>
                    </li>
                    <li class="search-now">

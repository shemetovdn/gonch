...
$this->registerJs("
        function initMap() {
            var myLatLng = {lat: 44.601994, lng: 33.523241};
    ...
    $this->registerJsFile('https://maps.googleapis.com/maps/api/js?key=AIzaSyDIPaMVi6Ld82YnqZi6PPF1-fdWo-27thc&callback=initMap');

...
class LiqPay
{
    ...
    public function cnb_form($params)
    {
        ...
        return sprintf('
            <form method="POST" id="liqPayForm" action="%s" accept-charset="utf-8">
                %s
                %s
                <!--button class="custom-button ripple scroll-down blackButton">
                    Оплатить
                </button-->
            </form>
            <script>
                setTimeout(function(){document.forms["liqPayForm"].submit();},100);
            </script>
            ',
            $this->_checkout_url,

...
<? $form = \yii\widgets\ActiveForm::begin(['action'=>['/orders/default/index'],'options' => ['class' => 'form-inline', 'id' => 'filterForm'], 'method' => 'get']); ?>

<div class="row">
    <div class="col-md-6">
        <div class="dataTables_length" id="example1_length">
            <label>
                Показанно <?=$form->field($searchModel,'per_page',['options'=>['class'=>'','style'=>'display:inline-block;']])->dropDownList(SearchModel::$pageSizeList,['placeholder'=>'', 'class'=>'form-control input-sm', 'style'=>'width:65px;'])->label(false)?> <?=$searchModel->per_page==-1?'записи':'записей'?>
            </label>
        </div>
    </div>
    <div class="col-md-6">

...
$bg='color: '.\backend\modules\ordersArchive\models\Orders::$order_colors[$model->status].';';
...
<td class="center" style="<?=$bg?>"><?=\backend\modules\ordersArchive\models\Orders::$order_statuses[$model->status]?></td>

...
class DefaultController extends BaseController
{
    ...
    {
        $available = ['facebook', 'google_plus',/* 'instagram','linkedin',  'twitter', 'pinterest','vk','skype','google_plus', 'facebook_app_id', 'facebook_api_secret', 'twitter_api_key', 'twitter_api_secret'*/];

...
class Banners extends WbpActiveRecord
{
    ...
    public static $imageTypes = ['banners'];
    ...
    {
        return [
            [['title', 'status', 'href', 'description', 'featured', 'sort', 'link', 'description_ua'], 'safe', 'on' => [WbpActiveRecord::ADMIN_ADD_SCENARIO, WbpActiveRecord::ADMIN_EDIT_SCENARIO]],

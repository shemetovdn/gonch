...
$(document).on(\'input\', \'#adverts-address\',function () {
      ...
      $(document).on(\'change\', \'#adverts-city_id\',function () {
        ...
        // Google map
                 ...
                 script.async = true;
                 script.src = \'https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDGuT2Um8grtR2yfhv5Ti8xpJVQ2vULiAY&language=ru&region=RU&sensor=false&callback=GoogleMap_init\';

...
//        $is_footer_menu,
    ...
    {
        return [
            [['widget_id','title','status','language_id','parent_page','title_ua', 'content', 'content_page', 'content_page_ua', /*'seo_title','seo_keywords','seo_h1','seo_description','is_footer_menu','is_middle_menu','is_top_menu',*/'in_lang','banner_title','short_description'],'safe','on'=>['edit','add']],
            [['href'],'safe'],
            [['title'],'required']
        ];
    }

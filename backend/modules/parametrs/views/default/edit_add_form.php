        ...
        <div class="col-lg-12">
            <div class="margin-bottom-50">
                ...
                <?=$form
                    ...
                    ->textInput(['placeholder'=>'Введите заголовок...'])->label('Название ua')
                ?>
...
<div id="values">
    ...
    <div class="row" id="field_value">
        <div   ng-repeat="item in parametrs_list track by $index"  class="col-md-4" style="margin-bottom: 15px;">
            ...
            <label style="width: 100%;"> ru<input type="text"  class="form-control" name="ParametrsValue[field_value][{{parametrs.count = $index}}][value]" value="{{item.value}}"></label>
            <label style="width: 100%;"> ua<input type="text"  class="form-control" name="ParametrsValue[field_value][{{parametrs.count = $index}}][value_ua]" value="{{item.value_ua}}"></label>
                ...
                <?php
                    $this->registerJs('
                       ...
                       if(id != 3){
                        ...
                        change_view($("#parametrs-field_type_id").val());

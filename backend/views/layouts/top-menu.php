...
<!--                    <div class="dropdown-divider"></div>-->
        ...
        <div class="menu-info-block">
            <div class="right hidden-md-down margin-left-20">
                <?
                    $form=\yii\widgets\ActiveForm::begin(['action'=>['/products/default/index'],'method'=>'get']);
                ?>
                <div class="search-block">
                    <div class="form-input-icon form-input-icon-right">
                        <i class="icmn-search"></i>
                        <?=$form->field(Yii::$app->controller->searchModel,'search')->textInput(['placeholder'=>'Поиск товара...', 'class'=>'form-control form-control-sm form-control-rounded'])->label(false)?>
<!--                        <input type="text" class="form-control form-control-sm form-control-rounded" placeholder="Поиск объекта недвижимости...">-->
            ...
            <div class="right example-buy-btn">
                <a href="<?=\yii\helpers\Url::to(['/products/default/add'])?>" class="btn btn-success-outline btn-rounded">
